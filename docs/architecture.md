...
| Reading agent | proposes records from pasted text; the route stages them as a draft | `src/hestia/agents/household_agent.py:401-449`, `src/hestia/app/agent.py:97-170` | extraction accuracy is unmeasured; a person confirms every fact |
