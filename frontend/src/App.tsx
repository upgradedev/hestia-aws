  ...
  const [dispatchHistory, setDispatchHistory] = useState<DispatchRecord[]>([
    {
      ...
      item_id: 'app-002',
      status: 'acknowledged',
      delivery_status: 'DELIVERED_VIA_SES',
      ses_message_id: 'ses-000-acknowledged-receipt',
    ...
    try {
      ...
      if (response.ok) {
        ...
        record = {
          ...
          item_id: itemId,
          status: 'dispatched',
          delivery_status: dr.delivery_status || 'DELIVERED_VIA_SES',
          ses_message_id: dr.ses_message_id || 'ses-msg-mock-250-ok',
      ...
      record = {
        ...
        status: 'dispatched',
        delivery_status: 'DELIVERED_VIA_SES',
        ses_message_id: `ses-${Date.now()}-mock-receipt`,
