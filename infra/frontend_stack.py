...
SPA_CODE = """function handler(event) {
  ...
  if (r.uri === '/' || /^\\/(overview|workspace|inventory|warranties|subscriptions|sentinel|radar|disputes|actions|settings|demo)(\\/[^.]*)?\\/?$/.test(r.uri)) {
    r.uri = '/index.html';
  }
  return r;
}"""  # noqa: E501
...
def template(product, repository, api_domain=""):
    if product not in {"lasttake", "merismos", "archon", "hestia"}:
    ...
    site_props = {
        ...
        "Tags": [
            {"Key": "project", "Value": product},
            {"Key": "purpose", "Value": "agentsforhumans-frontend"},
        ],
    }
    ...
    router_props = {
        ...
        "AutoPublish": True,
        "FunctionCode": SPA_CODE,
        "FunctionConfig": {
            "Comment": "Rewrite application paths only; API and missing assets stay errors",
    ...
    dist_config = {
        ...
        "Origins": [
            {
                "Id": "site",
                "DomainName": attr("Site", "RegionalDomainName"),
        ...
        "DefaultCacheBehavior": {
            **common,
            ...
            "FunctionAssociations": [{
                ...
                "FunctionARN": attr("Router", "FunctionARN"),
            }],
        },
        "CacheBehaviors": [
    ...
    site_policy_doc = {
        ...
        "Statement": [
            ...
            },
            {
                ...
                "Principal": "*",
                "Action": "s3:*",
                "Resource": [attr("Site", "Arn"), sub("${Site.Arn}/*")],
    ...
    release_assume_role = {
        ...
        "Statement": [{
            ...
            "Principal": {
                "Federated": sub(
                    "arn:${AWS::Partition}:iam::${AWS::AccountId}:oidc-provider/"
            ...
            "Condition": {"StringEquals": {
                ...
                "token.actions.githubusercontent.com:sub": sub(
                    "${GitHubSubjectPrefix}:ref:refs/heads/main"
                ),
            }},
        }],
    }
    ...
    resources = {
        "Site": {"Type": "AWS::S3::Bucket", "DeletionPolicy": "Retain",
                 "UpdateReplacePolicy": "Retain", "Properties": site_props},
        "Access": {"Type": "AWS::CloudFront::OriginAccessControl", "Properties": oac_props},
        "Router": {"Type": "AWS::CloudFront::Function", "Properties": router_props},
        "Headers": {"Type": "AWS::CloudFront::ResponseHeadersPolicy", "Properties": headers_props},
        "Distribution": {"Type": "AWS::CloudFront::Distribution", "Properties": {
            "DistributionConfig": dist_config,
            "Tags": [{"Key": "project", "Value": product}],
        }},
        "SitePolicy": {"Type": "AWS::S3::BucketPolicy", "Properties": {
            "Bucket": ref("Site"), "PolicyDocument": site_policy_doc,
        }},
        "ReleaseRole": {"Type": "AWS::IAM::Role", "Properties": {
            "RoleName": product + "-frontend-release",
            "MaxSessionDuration": 3600,
            "AssumeRolePolicyDocument": release_assume_role,
            "Policies": [{
                "PolicyName": "release-own-frontend-only",
                "PolicyDocument": release_policy,
            }],
        }},
    }
    ...
    return {
        ...
        "Description": product + " React frontend: private S3, CloudFront OAC, same-origin API.",
        "Parameters": {
            "GitHubSubjectPrefix": {
                "Type": "String",
                "AllowedPattern": "repo:[A-Za-z0-9_.@/-]+",
                "Description": (
                    "Read sub_claim_prefix from "
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--product", required=True, choices=["lasttake", "merismos", "archon", "hestia"]
    )
